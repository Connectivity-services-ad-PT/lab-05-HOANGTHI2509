...
build:
	docker build -t fit4110/core-policy-engine:lab05 .

# Run API container standalone (not via compose)
run:
	docker run --rm --name fit4110-core-api-lab05 -p 8000:8000 --env-file .env.example fit4110/core-policy-engine:lab05
